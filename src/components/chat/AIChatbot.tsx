...
export function AIChatbot() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-hidden relative">
        {activeTab === "chat" && (
          <div className="h-full relative flex flex-col">
            ...
            >
              <div className={cn("space-y-8 w-full", isFullScreen && "max-w-[850px] mx-auto")}>
                {messages.length <= 1 ? (
      ...
      {activeTab === "chat" && (
        <div className="p-4 border-t border-border shrink-0 bg-card/95 backdrop-blur-lg relative z-20">
          <div className={cn("w-full relative", isFullScreen && "max-w-[850px] mx-auto")}>
            <form
